        ...
        <div id="menu" class="menu">
            ...
            <div class="container">
                ...
                <div class="author-content">
                    <h4>Semih Yücel</h4>
                    <span>Web Backend Developer</span>
                </div>
                <nav class="main-nav" role="navigation">
                    <ul class="main-menu">
                        <li><a href="#section1">Hakkımda(About Me)</a></li>
                        <li><a href="#section2">İyi Olduğum Şeyler
                                (What I’m good at)</a></li>
                        <li><a href="#section3">Çalışmalarım (My Work)</a></li>
                        <li><a href="#section4">İletişim (Contact Me)</a></li>
                    </ul>
                </nav>
                ...
                <div class="copyright-text">
                    <p>Copyright 2022 Design by Semih Yücel</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="section about-me" data-section="section1">
        <div class="container">
            <div class="section-heading">
                ...
                <span>
                    Fırat Üniversitesi yazılım mühendisliği öğrencisiyim. Aynı zamanda
                    Fırat Üniversitesi Dijital Dönüşüm ve Yazılım Ofisi'nde backend developer olarak çalışıyorum.
                    Php Laravel üzerinde kodlama yapıyorum.
                    (I am a software engineering student at Firat University.
                    At the same time, I work as a backend developer at Fırat University Digital Transformation and Software Office.
                    I am coding on PHP Laravel.)</span>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="right-text">
                            <h4>Daha Fazla..</h4>
                            <p>
                                Php Laravel üzerine web tabanlı projeler geliştiriyorum ama tabi ki bununla yetinmeyeceğim.
                                Kendimi farklı alanlarda da geliştireceğim.
                            </p>
    ...
    <section class="section my-services" data-section="section2">
        <div class="container">
            <div class="section-heading">
                ...
                <div class="line-dec"></div>
                <span>Php Laravel alanında kendimiş yeterince geliştirdim.
                 Aynı zamanda html alanında da ilerledim. Panel tarafında da yeterince geliştiğimi düşünüyorum. Gerektiği zaman bu 3 dili bir arada kullanabiliyorum.</span>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="isotope-wrapper">
                    <form class="isotope-toolbar">
                        ...
                        ><input
                                ...
                                name="isotope-filter"
                            />
                            <span>takım çalışması</span> </label>
                    </form>
